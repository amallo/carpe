...
import { AppDispatch, AsyncThunkConfig, RootState } from '../../../app/store/store';
import { selectCurrentIdentity } from '../../identity/store/identity.slice';

export const submitMessage = createAsyncThunk<void, string, AsyncThunkConfig>('message/willBroadcastMessage',
